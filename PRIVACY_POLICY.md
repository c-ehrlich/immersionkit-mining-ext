...
Immersion Kit Mining Helper is a Chrome extension that helps the user send selected example sentence data from Immersion Kit to Anki through AnkiConnect.
...
- The selected example sentence on Immersion Kit
...
- To insert a custom action button on Immersion Kit example rows
...
## Where data is sent
- To Immersion Kit and Immersion Kit media endpoints, when needed to resolve the selected example and fetch media
