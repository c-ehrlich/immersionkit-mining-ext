  ...
  return (
    <main style={styles.page}>
      <div style={styles.card}>
        <h1 style={styles.title}>ImmersionKit Mining Helper</h1>
        <p style={styles.subtitle}>
          Configure which Anki note fields receive the sentence, image, and
          audio.
        </p>
          ...
          <label style={styles.label}>
            ...
            <input
              ...
              onChange={(event) =>
                setSettings((current) => ({
                  ...current,
                  ankiConnectUrl: event.target.value,
                }))
              }
            />
          </label>
          ...
          <label style={styles.label}>
            ...
            <input
              ...
              onChange={(event) =>
                setSettings((current) => ({
                  ...current,
                  sentenceField: event.target.value,
                }))
              }
            />
          </label>
          ...
          <label style={styles.label}>
            ...
            <input
              ...
              onChange={(event) =>
                setSettings((current) => ({
                  ...current,
                  latestNoteQuery: event.target.value,
                }))
              }
            />
          </label>
